...
#### 🇱🇰 Colombo — Live Weather Display

Displays real-time weather data with dynamic styling.
![Colombo](./screenshots/colombo.png)

---

### 📍 My Location Feature

Automatically fetches and displays weather based on the user's current location.
...
Displays a detailed 5-day forecast for the selected city, helping users plan ahead.
...
All changes instantly reflect across the UI.
